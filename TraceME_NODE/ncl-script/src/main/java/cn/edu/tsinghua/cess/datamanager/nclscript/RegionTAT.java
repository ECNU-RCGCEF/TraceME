...
// calling cdo to add all cdo.* files to create carbon storage nc.
       ...
       //File file_cdo_add = c        
        ...
        String[] Alia   = new String[11];
        Alia[0]  = "Carbon_Storage_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[1]  = "Carbon_Capacity_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[2]  = "Carbon_Potential_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[3]  = "npp_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[4]  = "Residence_Time_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[5]  = "gpp_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[6]  = "cue_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[7]  = "Baseline_Residence_Time_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[8]  = "Environmental_scalars_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[9]  = "Temperature_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        Alia[10]  = "Precipitation_LTM_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;    
        outputFiles[0]=new OutputFile(NclScriptContext.RESULT_TYPE_FIG,Alia,new String[]{"fig_name"},11);
       ...
       // cExecutor.runNcl_files(contextArray, file_ori_cdo, outputFiles, CmdExecutor.FIGURE_TYPE_ADDBOTH,"AnnualTAT.ncl", null);//get the results of npp, residence time, carbon potential and carbon storage.
        ...
        cExecutor.runPython_files(contextArray, file_ori_cdo, outputFiles, CmdExecutor.FIGURE_TYPE_ADDBOTH,"RegionTAT.py", null);       
