 ...
 * @author ericxuhao
 */
public class RegionOcean implements NclScript{
...
//        List<File>file_ori_cdo = new ArrayList<File>(); //recording the place of files
        ...
        String Alia="Ocean_"+lat_min+"-"+lat_max+"_"+lon_min+"-"+lon_max;
        ...
        cExecutor.runNcl_files(contextArray, file_ori_cdo, outputFiles, CmdExecutor.FIGURE_TYPE_ADDBOTH,"RegionOcean.ncl", null);
